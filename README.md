...
```env
APP_CONFIG=development #部署环境：production-生产环境;development-开发环境；testing-测出环境
...
人脸检测，检测图像中是否有人脸，已经人脸是否慢合图像合成的要求
#### 3.2.1 请求说明
- 请求方式**POST**，参数提交的方式为`FormData`
...
:----- | :----- | :----- | :-----
code | int | 是 | api请求结果状态码：200-请求成功；4100——4105:请求参数有误；5300:服务端错误；
error | str/null | 是 | 当检测到人脸，并且符合合成要求时为null，否则为人脸检测不同的原因
