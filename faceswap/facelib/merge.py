...
PREDICTOR_PATH = "./res/dlib/shape_predictor_68_face_landmarks.dat"
SCALE_FACTOR = 1 
FEATHER_AMOUNT = 11
...
im2, landmarks2 = read_im_and_landmarks('./docs/test_imgs/zxm5.jpeg')
...
# warped_corrected_im2 = cv2.seamlessClone(warped_im2, im1, numpy.uint8(combined_mask*255), (int(im1.shape[1]/2), int(im1.shape[0]/2), cv2.NORMAL_CLONE)
